...
public class MenuScreen extends Screen {
	...
	private CTextButton btnNewGame = new CTextButton("New Game", new Point2D.Double(MainFrame.FRAME_WIDTH / 2.0, MainFrame.FRAME_HEIGHT / 2.0 - 150), 400, 100, 10)
			{
				@Override
	...
	private CTextButton btnLoadGame = new CTextButton("Load Game", new Point2D.Double(MainFrame.FRAME_WIDTH / 2.0, MainFrame.FRAME_HEIGHT / 2.0), 400, 100, 10)
			{
				@Override
				public void onRelease() {
					if (waitingForBtnPress) {
	...
	public void onScreenOpen() {
		...
		CButtonManager.addButtons(btnNewGame, btnLoadGame, btnOptions, btnQuit);
